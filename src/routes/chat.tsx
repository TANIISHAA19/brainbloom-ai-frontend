...
import { mockChat, suggestedPrompts, type ChatMessage } from "@/data/mock";
...
function ChatPage() {
  ...
  const send = (text?: string) => {
    ...
    setMessages((m) => [...m, { id: Date.now(), role: "user", content, time: now }]);
    setInput("");
    setTyping(true);
    ...
    setTimeout(() => {
      setMessages((m) => [
        ...m,
        {
          ...
          role: "assistant",
          content:
            "Great question! Here's a placeholder explanation. Connect a backend to power real AI responses.",
    ...
    <PageShell>
      <div className="mx-auto max-w-3xl">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground">Ask anything — get instant explanations.</p>
        </div>
